...
public class FuncoesString {
	...
	public int retornarCaractereNaPosicao(String nome, int i) {
		char letra = nome.charAt(i);
		System.out.println("A letra na posição " + (i+1) + " é " + letra);
		return letra;
	}
	
	public String retornarStringaPartirDoIndice(String nome, int i) {
		String novaString = nome.substring(5);
	...
	public int retornarPrimeiroIndice(String nome, String letra) {
		...
		System.out.println("A primeira posição encontrada é " + (posicao + 1));
		return posicao;
	}
	...
	public boolean isIgual2(String nome1, String nome2) {
